      ...
      <div className="grid grid-cols-2 padding">
        <div>
          ...
          <p className="text-[16px]">
            ...
            <br />
            <br />
            My passion for web development sparked in 2019 when I was attending
            a Software Development PLC (Post Leaving Certificate) course. During
            this course I experienced many different kinds of development but
            the one that caught my eye the most was frontend development.
            <br />
            <br />
            ...
            graduation.
            <br />
            <br />I am currently on the hunt for a Frontend job after graduating
            college this May of 2023.
          </p>
        </div>
        <div>
          <img
